...
n_acc=[40,0];
acc_kurt=movkurt(acc,n_acc);

figure("Name","Kurtosi Accelerazione")
subplot(3,1,1)
plot(t,acc_kurt(:,1),LineWidth=1,Color="r")
title("Kurtosi Accelerazione")
subtitle("X")
xlabel("t(s)")
ylabel("m/s^2")
grid
subplot(3,1,2)
plot(t,acc_kurt(:,2),LineWidth=1,Color="g")
subtitle("Y")
xlabel("t(s)")
ylabel("m/s^2")
grid
subplot(3,1,3)
plot(t,acc_kurt(:,3),LineWidth=1,Color="b")
subtitle("Z")
xlabel("t(s)")
ylabel("m/s^2")
grid
...
%% Kurtosi Accelerazione Filtrata
n_fitered_acc=[40,0];
filtered_acc_kurt=movkurt(filtered_acc,n_fitered_acc);

figure("Name","Kurtosi Accelerazione Filtrata")
subplot(3,1,1)
plot(t,filtered_acc_kurt(:,1),LineWidth=1,Color="r")
title("Kurtosi Accelerazione Filtrata")
subtitle("X")
xlabel("t(s)")
ylabel("m/s^2")
grid
subplot(3,1,2)
plot(t,filtered_acc_kurt(:,2),LineWidth=1,Color="g")
subtitle("Y")
xlabel("t(s)")
ylabel("m/s^2")
grid
subplot(3,1,3)
plot(t,filtered_acc_kurt(:,3),LineWidth=1,Color="b")
subtitle("Z")
xlabel("t(s)")
ylabel("m/s^2")
grid
...
%% Kurtosi Velocità
n_vel=[40,0];
vel_kurt=movkurt(vel,n_vel);

figure("Name","Kurtosi Velocità")
subplot(3,1,1)
plot(t,vel_kurt(:,1),LineWidth=1,Color="r")
title("Kurtosi Velocità")
subtitle("X")
xlabel("t(s)")
ylabel("m/s")
grid
subplot(3,1,2)
plot(t,vel_kurt(:,2),LineWidth=1,Color="g")
subtitle("Y")
xlabel("t(s)")
ylabel("m/s")
grid
subplot(3,1,3)
plot(t,vel_kurt(:,3),LineWidth=1,Color="b")
subtitle("Z")
xlabel("t(s)")
ylabel("m/s")
grid
...
%% Kurtosi Velocità Angolare
n_vang=[40,0];
vang_kurt=movkurt(vang,n_vang);

figure("Name","Kurtosi Velocità Angolare")
subplot(3,1,1)
plot(t,vang_kurt(:,1),LineWidth=1,Color="r")
title("Kurtosi Velocità Angolare")
subtitle("X")
xlabel("t(s)")
ylabel("rad/s")
grid
subplot(3,1,2)
plot(t,vang_kurt(:,2),LineWidth=1,Color="g")
subtitle("Y")
xlabel("t(s)")
ylabel("rad/s")
grid
subplot(3,1,3)
plot(t,vang_kurt(:,3),LineWidth=1,Color="b")
subtitle("Z")
xlabel("t(s)")
ylabel("rad/s")
grid
...
%% Kurtosi Integrale Velocità Angolare
n_ang=[40,0];
ang_kurt=movkurt(ang,n_ang);

figure("Name","Kurtosi Integrale Velocità Angolare")
subplot(3,1,1)
plot(t,ang_kurt(:,1),LineWidth=1,Color="r")
title("Kurtosi Integrale Velocità Angolare")
subtitle("X")
xlabel("t(s)")
ylabel("rad")
grid
subplot(3,1,2)
plot(t,ang_kurt(:,2),LineWidth=1,Color="g")
subtitle("Y")
xlabel("t(s)")
ylabel("rad")
grid
subplot(3,1,3)
plot(t,ang_kurt(:,3),LineWidth=1,Color="b")
subtitle("Z")
xlabel("t(s)")
ylabel("rad")
grid
...
%% Kurtosi Campo Magnetico
n_mag=[40,0];
mag_kurt=movkurt(mag,n_mag);

figure("Name","Kurtosi Campo Magnetico")
subplot(3,1,1)
plot(t,mag_kurt(:,1),LineWidth=1,Color="r")
title("Kurtosi Campo Magnetico")
subtitle("X")
xlabel("t(s)")
ylabel("µT")
grid
subplot(3,1,2)
plot(t,mag_kurt(:,2),LineWidth=1,Color="g")
subtitle("Y")
xlabel("t(s)")
ylabel("µT")
grid
subplot(3,1,3)
plot(t,mag_kurt(:,3),LineWidth=1,Color="b")
subtitle("Z")
xlabel("t(s)")
ylabel("µT")
grid
...
function[sqm] = movkurt(f,n)
sqm=zeros(length(f),3);

for i=1:n
    sqm(i,1)=kurtosis([zeros(n-i),f(1:i,1)]);
    sqm(i,2)=kurtosis([zeros(n-i),f(1:i,2)]);
    sqm(i,3)=kurtosis([zeros(n-i),f(1:i,3)]);
end

for i=n+1:length(f)
    sqm(i,1)=kurtosis(f(i-n:i,1));
    sqm(i,2)=kurtosis(f(i-n:i,2));
    sqm(i,3)=kurtosis(f(i-n:i,3));
end
