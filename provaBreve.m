...
dbg=importdata("dbdm\breve\BlueCoin_Log_N000.csv");
...
%%
db1=importdata("dbdm\breve\BlueCoin_Log_N017.csv");
...
figure
subplot(3,1,1);
plot(t,accr(:,1),LineWidth=1,Color="r")
grid
subplot(3,1,2);
plot(t,accr(:,2),LineWidth=1,Color="g")
grid
subplot(3,1,3);
plot(t,accr(:,3),LineWidth=1,Color="b")
grid
